...
# from deep_learning_technique.denoiser.models.gan_model import TomoGAN as Generator
...
class CDGAN:
    ...
    def load_model(self):
        ...
        # # print(self.netg.load_state_dict(torch.load(os.path.join(OUTPUT_PATH, 'netg.pth'))))
        # path = os.path.join(OUTPUT_PATH,'netg.pth')
        # device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
        # self.netg.load_state_dict(torch.load(path,map_location=torch.device(device))['model_state_dict'])
