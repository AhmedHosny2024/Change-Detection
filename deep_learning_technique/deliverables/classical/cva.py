...
def main():
    data_set_X = cv2.imread('E:/College/Fourth Year/second term/RSSI/Project/Change-Detection/trainval/A/0069.png')
    data_set_Y = cv2.imread('E:/College/Fourth Year/second term/RSSI/Project/Change-Detection/trainval/B/0069.png')
