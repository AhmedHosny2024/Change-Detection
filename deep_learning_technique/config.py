...
TEST_FOLDER_PATH = 'trainval/archive (2)/subset/test'
VAL_FOLDER_PATH = 'trainval/validation_onsever'
OUTPUT_PATH = 'deep_learning_technique/output_best_model_change_schedular'
IM_SAVE_DIR ='deep_learning_technique/output_best_model_change_schedular'
...
G_WEIGHT = 100    # loss weight
D_WEIGHT = 1        # loss weight
L1_WEIGHT = 3     # target 1 weight
...
EXTRALAYERS = 1 # add extral layers for the generator and discriminator
Z_SIZE = 16
